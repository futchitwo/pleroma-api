...
// Lifted the data from the WIP MR
// https://git.pleroma.social/pleroma/pleroma/-/blob/3d040b1a87da66ed53a763f781477bd4f5a146d3/docs/API/chats.md
...
describe('Chats api', () => {
  ...
  it('POST /api/v1/pleroma/chats/:id/messages', async () => {
    ...
    const res = await api.chats.post({ config, params: { id: 22, content: 'hello' } })
